...
* [특정 리모트 브랜치 트래킹된 로컬 브랜치 만들기](#특정-리모트-브랜치-트래킹된-로컬-브랜치-만들기)
* [이미 존재하는 로컬 브랜치로 리모트 브랜치 트래킹하기](#이미-존재하는-로컬-브랜치로-리모트-브랜치-트래킹하기)
...
## 리모트 브랜치 트래킹된 로컬 브랜치 만들기
```sh
git git checkout -t <remote>/<branch>
```

## 이미 존재하는 로컬 브랜치로 리모트 브랜치 트래킹하기
```sh
